<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nuestras_propiedades.aspx.cs" Inherits="YOKANJEO.Inicio.Nuestras_propiedades" %>
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>YOKANJEO |  Inmobiliaria</title>
...
<link href="css/Nuestras.css" rel="stylesheet" />
	<!-- Modernizr JS -->
	<script src="js/modernizr-2.6.2.min.js"></script>
	
		 <a href="../Home/Home.aspx" class="logo">
        <img src="../Images/Icono.jpg" width="100" height="100" alt="">
    </a> 
	</head>
	<body>
...
<header class="header">
    ...
    <a href="../Home/Home.aspx" class="logo">
        <img src="../Images/Icono.jpg" width="140" height="140" alt="">
    </a>
    ...
    <nav class="navbar">
        ...
        <a href="Nuestras_propiedades.aspx">Algunos proyectos </a>
		...
		<aside id="fh5co-hero" class="js-fullheight">
			<div class="flexslider js-fullheight">
				<ul class="slides">
			   	<li style="background-image: url(../../Images/casa9.jpg);">
				   			...
				   			<div class="col-md-4 col-md-offset-4 col-md-pull-4 js-fullheight slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc">
				   						...
				   						<h1>Nueva casa, Santiago</h1>
											<h2 class="precio">$4.000.000</h2>
			   	...
			   	<li style="background-image: url(../../Images/cas10.jpg);">
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-4 col-md-offset-4 col-md-pull-4 js-fullheight slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc">
				   						...
				   						<h1>Nueva casa, Viña del mar</h1>
											<h2 class="precio">$2000/mos</h2>
											<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
											<p class="details">
												<span>2000 ft sq</span>
												<span>4 Bedrooms</span>
			   	...
			   	<li style="background-image: url(../../Images/casa5.jpg);">
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-4 col-md-offset-4 col-md-pull-4 js-fullheight slider-text">
				   				<div class="slider-text-inner">
		...
		<div id="fh5co-search-map">
			...
			<div class="map" style="background-image: url(../../Images/casa13.jpg);">
			</div>
		</div>
		...
		<div id="fh5co-popular-properties" class="fh5co-section-gray">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 animate-box">
						<a href="#" class="fh5co-property" style="background-image: url(../../Images/casa5.jpg);">
							<span class="status">Sale</span>
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="fh5co-property" style="background-image: url(../../Images/casa4.jpg);">
							<span class="status">Rent</span>
							<div class="prop-details">
					...
					<div class="col-md-4 animate-box">
						<a href="#" class="fh5co-property" style="background-image: url(../../Images/casa3.jpg);">
							<span class="status">Sale</span>
							<div class="prop-details">
								<span class="price">$3,000</span>
		...
		<div id="fh5co-contact" class="fh5co-contact">
			...
			<div class="half-bg" style="background-image: url(../../Images/casa10.jpg);"></div>
		</div>
		<footer>
			<div id="footer">
				<div class="container">
