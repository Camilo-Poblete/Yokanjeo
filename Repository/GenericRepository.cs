...
namespace YOKANJEO.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private InmoYOKAEntities _DBEntity;

        public GenericRepository(InmoYOKAEntities DBEntity)
        {
            _DBEntity = DBEntity;
            _dbSet = _DBEntity.Set<Tbl_Entity>();
        }
        public IEnumerable<Tbl_Entity> GetPropiedad()
        {
        ...
        public IEnumerable<Tbl_Entity> GetPropiedad(int propiedadId)
        {
            return _dbSet.ToList();
        }

        //public IEnumerable<Tbl_Entity> GetPropiedad(int propiedad)
        //{
        //    return _dbSet.ToList();
        //}
    }
